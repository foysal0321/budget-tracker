    ...
    return (
        <div className='chart-header'>
           ...
           <div className="chart-info">
            <div className="info1">
              <div className="flex">
                <div className="w-2 h-2 rounded py-3 bg-yellow-500 "></div>
                 <p className='mx-2'>Expense</p>
              </div>             
             <span>{25}%</span>
            </div>
            <div className="info1 py-2">
            <div className="flex">
                <div className="w-2 h-2 rounded py-3 bg-green-600 "></div>
            ...
            <div className="info1">
            <div className="flex">
                <div className="w-2 h-2 rounded py-3 bg-red-800 "></div>
